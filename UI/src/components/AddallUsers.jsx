...
//             // Example redirect:
//             window.location.href = '/admin/addallusers'; // Redirect to asset inventory page
//         } catch (error) {
...
//                             window.location.href = '/admin/addallusers'; // Example redirect to asset inventory page
//                         }}
//                     >
//                         Cancel
//                     </button>
